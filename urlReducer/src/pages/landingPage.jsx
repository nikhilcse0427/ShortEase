    ...
    <div className="flex flex-col items-center justify-center ">
      ...
      <form onSubmit={handleShorten} className="sm:h-14 flex flex-col sm:flex-row md:flex-row w-full sm:w-2/5 gap-2 justify-center items-center">
        <input
          ...
          className="h-full flex-1 px-4 py-4 rounded-md text-2xl border-2px"
      ...
      <img src="../public/banner.png" alt="banner page" className="w-full h-140 my-11 md:px-22" />
      <Accordion type="multiple" collapsible className="w-full md:px-35">
        <AccordionItem value="item-1">
          <AccordionTrigger>How does the ShortEase url shortner works?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger>Do i need to make an account to use this app?</AccordionTrigger>
          <AccordionContent>
